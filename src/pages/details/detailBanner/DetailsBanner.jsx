...
const DetailsBanner = ({ video, crew }) => {
  ...
  const writer = crew?.filter((f) => f.job === 'Screenplay' || f.job === 'Sotry' || f.job === 'Writer');
                    ...
                    <div className='right'>
                      ...
                      <div className='row'>
                        ...
                        <div
                          className='playbtn'
                          onClick={() => {
                            setShow(true), setVideoId(id), setVideoType(mediaType);
                          }}>
                          <PlayIcon />
                          <span className='text'>Watch Full</span>
                        </div>
                      </div>
